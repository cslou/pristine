...
- **Functional verification:**
  - [ ] `npm run test:integration` shows the 10 new harness tests as failing with the stub-throw error message (NOT TS errors); pass condition: error stack mentions `searcher.sql: not implemented`.
