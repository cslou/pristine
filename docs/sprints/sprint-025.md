...
- **Functional verification:**
  ...
  - [x] Run the audit command against reachable git history and confirm it exits 0 or produces only documented false positives. Evidence: final integration rerun scanned 927 reachable commits before the report commit and 956 unique history findings, all false positives.
