...
- **Functional verification:**
  ...
  - [x] Run the audit command against reachable git history and confirm it exits 0 or produces only documented false positives. Evidence: same command scanned 914 reachable commits and 90 unique history findings, all false positives.
