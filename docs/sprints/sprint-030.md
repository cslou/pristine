...
- **Implementation evidence:**
  ...
  - `pnpm run test:unit -- tests/privacy/detect.test.ts tests/classifier/deterministic-classifier.test.ts tests/privacy/safety-scan.test.ts` passed; log: `/var/folders/d9/c72wvkps2px78k5rcxwg8rdr0000gn/T/pristine-detect-test-XXXX.log.UzfoXijSfK`.
  ...
  - `pnpm run typecheck` passed; log: `/var/folders/d9/c72wvkps2px78k5rcxwg8rdr0000gn/T/pristine-typecheck-detect-XXXX.log.v4fbXZmJoK`.
  - `pnpm run lint` passed; log: `/var/folders/d9/c72wvkps2px78k5rcxwg8rdr0000gn/T/pristine-lint-detect-XXXX.log.su6zhPqTQg`.
...
- **Acceptance criteria:**
  ...
  - [ ] The classifier callback input does not include raw candidate strings, arbitrary raw prefixes/suffixes, decoded JWT payload values, connection-string passwords, query secret values, or seed phrase words; any `sourceSpan` metadata is numeric offset metadata only.
