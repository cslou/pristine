...
2. Use the ranked hit metadata and any explicitly enabled bounded `snippet` to pick the relevant hit, then use `sourcePointer.sourceUri` and `sourcePointer.lineNumber` or `sourcePointer.entryId` with the skill.
