...
// the spec-005 Phase-1 removal sweep. The Phase-3 indexer (spec-005 §5.1,
// see `indexer` primitive) will import it for oversize-conversation
// handling. Until then there is no runtime consumer in `src/` — only the
// chunker.test.ts unit test.
